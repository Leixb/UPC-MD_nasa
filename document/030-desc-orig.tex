...
four different categories:
    ...
    \paragraph{FALSE POSITIVE} Observations that have failed at least one
    of the tests.
...
\begin{xltabular}{\textwidth}{ l c X c }
    ...
    \texttt{koi\_tce\_delivname} & C & TCE delivery name corresponding to the TCE data federated to the KOI & \makecell{q1\_q17\_dr25\_tce\\q1\_q16\_tce\\q1\_q17\_dr24\_tce} \\
